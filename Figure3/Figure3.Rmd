...
setwd("/home/xcfang/Software/metorigin2/code4imeta/Figure3")
...
p <- Orthology_Pieplot(data = data,K = "K11358")
print(p)
```
...
res <- Mediate_Sankey(micro_meta = micro_meta,meta_pheno = meta_pheno,Level =  "genus")
res
...
Data <- read.xlsx("Figure3_E_data.xlsx")
VarList <- list(Microbiome = "Clostridium",
                Metabolite = "cystine",
                Phenotype = "BMI-Zscore")

model <- Mediation(Data = Data,VarList = VarList)
model$BetaData
model$Result
model$PlotList[[1]]
```
